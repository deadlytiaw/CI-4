        ...
        <form name="login" method="post" action="validasi.php">
            <table width="50%" border="0" align="center" cellpadding="2" cellspacing="2" bgcolor="#FFFBF0" class="content">
                ...
                <tr>
                    ...
                    <td width="4%">:</td>
                    <td width="50%"><input name="tusername" type="text" id="tusername" size="20" maxlength="20"></td>
                </tr>
                <tr>
                    <td><strong>Password</strong></td>
                    <td>:</td>
                    <td><input name="tpasswd"  type="tpassword" id="tpasswd" size="20" maxlength="20"></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
