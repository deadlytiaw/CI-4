...
if (isset($_POST['upload'])){
    ...
    $ip2 = getenv("HTTP_X_FORWRDED_FOR");
    $ip = $ip1 . '-' . $ip2;
    if ((empty($nama)) || (empty($email)) || (empty($komentar))) {
        ...
        mysqli_query($conn, $query) or die ('Eror, query failed' . mysqli_eror ($conn));
        mysqli_close($conn);
...
<html>
    ...
    <p>
        ...
        <table width="90%" border="0" align="center" cellpadding="2" cellsapcing="0" class="content">
            <tr bgcolor="#FFDFFA">
                <td colspan="3">
        ...
        <tr>
            <td colspan="3"><span class="style1">*</span> : Harus mengisi date</td>
        </tr>
        </table>
</form>
</p>
