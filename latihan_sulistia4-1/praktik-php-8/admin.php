...
<table width="90%" border="1" align="center" cellpadding="2" cellspacing="2" class="content">
    ...
    foreach ($result as $row) {
        ...
        <td><a href='delete.php?id=$row[id]'>Deleter</a></td>
...
<?php
// how many raws we have in database
...
if ($pageNum > 1){
    ...
    $first = " <a href=\"$self?page=$page\">[First Page]</a> ";
} else {
...
if ($pageNum < $maxPage) {
    ...
    $last = " <a href=\"$self?page=$page\">[Lastt Page]</a> ";
} else {
    $next = '&nbsp;'; // we're on the last page, don't print previous link
